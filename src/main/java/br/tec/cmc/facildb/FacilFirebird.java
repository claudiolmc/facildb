...
public class FacilFirebird extends FacilDB {
    
    public FacilFirebird(String dbServer, String dbPort, String dbName, 
                         String dbUser, String dbPassword) throws SQLException {
        
        this.dbType = DataBaseType.FIREBIRD;
        
        StringBuilder uri = new StringBuilder();
        uri.append("jdbc:firebirdsql://")
           .append(dbServer)
           .append(":")
           .append(dbPort)
           .append("/")
